            ...
            <div class="wrapper-form">
                <div class="row">
                    <div class="col-md-7 col-lg-7">
                        <form method="POST" action="/product?method=create" class="needs-validation" novalidate>
                            <div class="row">
                                <div class="col-sm-12">
                                ...
                                <div class="col-6 mt-2">
                                    <label class="form-label">Total de Produtos Disponíveis
                                        <input type="number" class="form-control w-100" id="totalProduct" name="totalProduct" placeholder="100" required min="0">
                                        <div class="invalid-feedback">
                                            Por favor insira um total inteiro e válido de produtos
                                        </div>
                                </div>
                            ...
                            <button class="w-50 btn btn-success btn-lg mt-2" type="submit">Cadastrar Produto</button>
                        </form>
                    </div>
                </div>
            </div>
